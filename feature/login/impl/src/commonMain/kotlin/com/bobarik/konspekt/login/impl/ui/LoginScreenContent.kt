...
import com.bobarik.konspekt.login.impl.component.LoginEvent
import com.bobarik.konspekt.login.impl.component.LoginState
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            IconButton(
                ...
                val imageVector =
                    if (state.isPasswordVisible) Icons.Default.Close else Icons.Default.Edit
                Icon(
                    imageVector,
